...
# PUZZLE_DATE = "2023-02-03" # "2024-06-25"

# retrieve puzzle ID from puzzle date

def get_data(PUZZLE_DATE):
    ...
    #response_date = requests.get(f"https://www.nytimes.com/svc/wordle/v2/{PUZZLE_DATE}.json",timeout=10).json()
    ...
    if response['states'] == []:
        print("combo_func.py: No data returned")
    else:
